...
<body>
    ...
    <section class="portfolio-items padding-top-120 padding-bottom-120">
        ...
        <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="portfolio-image">
                            <a href="portfolio-details.html"><img src="assets/images/gallery-2.png" alt=""></a>
            ...
            <div class="single-portfolio-item">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="portfolio-image">
                            <a href="portfolio-details.html"><img src="assets/images/gallery-3.png" alt=""></a>
                            <div class="hover-state">
                                <a href="portfolio-details.html"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 align-self-lg-center">
                        <div class="portfolio-content">
                            <h2 class="title">personal finance app</h2>
                            <div class="project-para">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore repudiandae iure assumenda aperiam ut?</p>
                            </div>
                            <div class="project-details">
            ...
            <div class="single-portfolio-item">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="portfolio-image">
                            <a href="portfolio-details.html"><img src="assets/images/gallery-7.png" alt=""></a>
                            <div class="hover-state">
                                <a href="portfolio-details.html"><i class="fa fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-5 align-self-lg-center">
                        <div class="portfolio-content">
                            <h2 class="title">ecommerce website design</h2>
                            <div class="project-para">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore repudiandae iure assumenda aperiam ut?</p>
                            </div>
                            <div class="project-details">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="#" class="template-btn portfolio-btn">load more</a>
                </div>
            </div>
        </div>
    </section>
